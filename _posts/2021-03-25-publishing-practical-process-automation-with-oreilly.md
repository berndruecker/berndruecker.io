---
layout: post
title: "Publishing “Practical Process Automation” With O’Reilly"
...
It is done and I am happy to share that my new book called [“Practical Process Automation” is officially published by O’Reilly](https://learning.oreilly.com/library/view/practical-process-automation/9781492061441/).

In this book, I distilled [my practical experience implementing process automation solutions from the last two decades](https://berndruecker.io/bio.php).

![](https://cdn-images-1.medium.com/max/800/1*1CX5KNsoi3YhBWE_3UFjAA.png)
...
- [**Get This Book From O’Reilly**](https://learning.oreilly.com/library/view/practical-process-automation/9781492061441/)** **as part of your O’Reilly subscription. You can also start[ a free 30 days trial](https://learning.oreilly.com/get-learning/?code=PPAER20).
- [**Get Your Free Electronic Copy**](https://page.camunda.com/wp-practical-process-automation-book-digital-release), as [Camunda](https://camunda.com/) was so kind to sponsor that a free electronic copy is available.

The book should be available [**on Amazon**](https://www.amazon.com/Practical-Process-Automation-Orchestration-Microservices/dp/149206145X)** **and other book stores soon.

You can find the books website here: [https://ProcessAutomationBook.com](https://ProcessAutomationBook.com)

![](https://cdn-images-1.medium.com/max/800/1*8JCdpATDls7iShcbUJ5zeA.png)
...
First of all let me describe the **tech stack** I used for writing, based on the [O’Reilly Atlas stack](https://docs.atlas.oreilly.com/) with Git, Asciidoc, and some magic to produce the final artifacts. I used Visual Studio Code to write. Furthermore, I used[ Drawboard PDF on my Microsoft Surface to re-read and edit](https://twitter.com/berndruecker/status/1242037143402360832). That setting worked like a charm for me.

> 

Some dates:

- 2019-January-24: Date when I first drafted my initial idea of the book
- 2019-November-18: Date I signed the contract with O’Reilly
- 2019-November-19: Date of my first commit on the book sources
- 2021-March-15: Date of my last commit on the book sources
- 2021-March-1: 7Date when the final book hit the O’Reilly platform

In Git history, you can see how the content evolved over time.

![](https://cdn-images-1.medium.com/max/800/0*ZsSw3QaHfaqpftPt)
...
![](https://cdn-images-1.medium.com/max/800/0*_M1ZVXxLHEmsk1Yn)

But the statistics also reveal that I was really good not to commit on the weekends!

![](https://cdn-images-1.medium.com/max/800/0*brzUVVw3LzIvfUJR)
